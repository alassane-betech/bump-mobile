...
export const DuelsIconFocused = ({ height, width, color }: IconProps) => (
  <Svg width={width} height={height} fill="none">
    <Path
      stroke={color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m15.669 2-3.155 3.155m0 0-.064.064m.064-.064c-.901.901-1.327 2.07-1.268 3.162.029.533-.126 1.06-.504 1.439l-6.363 6.123A1.5 1.5 0 0 0 6.5 18l6.363-6.123c.378-.378.905-.533 1.44-.504 1.09.06 2.26-.367 3.16-1.268L20.62 6.95M14.668 7.95l3.535-3.535M13.793 15.5l2.252 2.251a1.5 1.5 0 0 0 2.121-2.12L17 14.475M8 6 5.257 3.293 4 2a1 1 0 0 0-1.414 0l-.465.414a3 3 0 0 0 0 4.242L6 10.5"
    />
  </Svg>
);
